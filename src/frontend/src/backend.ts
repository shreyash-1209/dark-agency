...
import type { PortfolioProject as _PortfolioProject } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async getProjectById(arg0: string): Promise<PortfolioProject | null> {
        if (this.processError) {
            try {
    ...
    async submitContact(arg0: string, arg1: string, arg2: string, arg3: string, arg4: string): Promise<ContactSubmission> {
        if (this.processError) {
            try {
...
function from_candid_opt_n1(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_PortfolioProject]): PortfolioProject | null {
