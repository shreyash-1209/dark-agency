...
Service({
  ...
  "getPortfolioProjects": Func([], [Vec(PortfolioProject)], ["query"]),
  "getProjectById": Func(
    [Text],
    [Opt(PortfolioProject)],
    ["query"]
  ),
  "submitContact": Func(
...
const idlFactory = ({ IDL: IDL2 }) => {
  ...
  const PortfolioProject2 = IDL2.Record({
    "id": IDL2.Text,
    "client": IDL2.Text,
    "title": IDL2.Text,
    "briefDescription": IDL2.Text,
    "outcomes": IDL2.Text,
    "imageUrl": IDL2.Text,
    "category": IDL2.Text,
    "fullDescription": IDL2.Text,
  ...
  return IDL2.Service({
    ...
    "getPortfolioProjects": IDL2.Func(
      [],
      [IDL2.Vec(PortfolioProject2)],
      ["query"]
    ),
    "getProjectById": IDL2.Func(
      [IDL2.Text],
      [IDL2.Opt(PortfolioProject2)],
      ["query"]
    ),
...
class Backend {
  ...
  async submitContact(arg0, arg1, arg2, arg3, arg4) {
    if (this.processError) {
      try {
